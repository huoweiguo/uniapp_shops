<template>
	<view class="entry_exit">
		<view class="eeTimes">
			<view class="ee-date">
				<uni-datetime-picker v-model="pageReqVO.createTime" type="daterange" start="2021-3-20" end="2021-5-20"
					rangeSeparator="~" @change="getEntryRecord" />
			</view>
			<view class="ee-total">
		...
		data() {
			return {
				...
				pageReqVO: {
					pageNo: 1,
					pageSize: 10,
					createTime: ['2025-01-01', '2025-01-20']
				},
				list: []
			}
		},
